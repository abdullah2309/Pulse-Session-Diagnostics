            ...
            <div className="mb-6">
              <div className="flex flex-col xl:flex-row items-start xl:items-center justify-between gap-4 mb-4">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-0.5">Test real-time bandwidth speeds, webcam/mic privileges, graphics stress performance, and browser security signatures</p>
                </div>
